...
const anxietyQuestions = [
  {
    ...
    question:
      "أشعر بالضيق عندما يسألني الأستاذ من أجل اختبار مدى استفادتي من الدرس.",
    options: [
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "عندما يطلب مني الأستاذ انجاز تمرين على السبورة أتمنى لو طلب ذلك من تلميذ آخر.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "أشعر بالقلق الشديد أثناء تفكيري في الإمتحانات المقبلة خاصة أثناء الاستعداد للنوم.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "ترتجف (ترتعد) يدي عندما يطلب الأستاذ مني الكتابة على السبورة أمام زملائي.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "إذا تغيبت عن المدرسة بسبب مرض أشعر أن أدائي سوف يكون أقل من زملائي.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "عندما أفكر بدروس اليوم التالي أشعر بالقلق بأن أدائي (إنجازي) في بعض الدروس لن يكون جيدا.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "أشعر بالغثيان والارتجاف (الارتعاد) أو الدوار (الدوخة) عندما يسألني الأستاذ للتأكد من مدى استفادتي من الدرس.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "بعد الانتهاء من الإمتحان أشعر بالتوتر حيال أدائي حول مدى صحة إجاباتي.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "أشعر أحيانا أن أدائي في الإمتحان كان سيئا بالرغم من تحضيري واستعدادي له.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "أشعر أنني أنسى في الإمتحان كثيرا من المعلومات التي كنت أتذكرها قبل بدئه.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "أخاف أحيانا عندما أكون ذاهبا إلى المدرسة أن يفاجئنا الأستاذ بتمرير امتحان.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "أشعر بالقلق أثناء الإمتحان خوفا من ألا يكفيني الوقت للإجابة عن أسئلته.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_EXAMENS",
    question:
      "أشعر بعدم الارتياح أثناء تحدث التلاميذ في الساحة عن امتحان قادم.",
    options: [
      { value: 1, text: "لا يحدث أبدا" },
      { value: 2, text: "يحدث أحيانا" },
      { value: 3, text: "يحدث غالبا" },
...
const AnxietyExams: React.FC = () => {
  ...
  const progressPercentage =
    ((currentQuestionIndex + 1) / anxietyQuestions.length) * 100;
      ...
      <div className="container py-10">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl font-bold mb-6">
            Test d'Anxiété face aux examens
          </h1>
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>
                Question {currentQuestionIndex + 1}/{anxietyQuestions.length}
              </CardTitle>
              <CardDescription>
                Veuillez répondre honnêtement à chaque question en fonction de
                votre expérience au cours des deux dernières semaines.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="text-center text-sm text-gray-500">
            <p>
              Vous pouvez abandonner le test à tout moment, mais vos réponses ne
