...
const anxietyQuestions = [
  ...
  },
  {
    ...
    axis: "تقدير الذات المدرسي",
    question:
      "أشعر بأنني محروم من حظوظ الأساتذة الذين درسوني منذ التحاقي بالمدرسة إلى الآن.",
    options: [
      { value: 1, text: "تنطبق تماما" },
      { value: 2, text: "تنطبق غالبا" },
      { value: 3, text: "تنطبق بدرجة متوسطة" },
  ...
  },
  {
    ...
    axis: "تقدير الذات الرفاقي",
    question:
      "بعض الأصدقاء يعتقدون أنني أمرح كثيرًا أو أنني من الممتع أن أكون معهم.",
    options: [
      { value: 1, text: "تنطبق تماما" },
      { value: 2, text: "تنطبق غالبا" },
      { value: 3, text: "تنطبق بدرجة متوسطة" },
  ...
  },
  {
    ...
    axis: "تقدير الذات الرفاقي",
    question:
      "لو أن أصدقائي قرروا التصويت لإقادة المجموعة فسوف ينتخبونني ضمن المراكز القيادية العليا.",
    options: [
      { value: 1, text: "تنطبق تماما" },
      { value: 2, text: "تنطبق غالبا" },
      { value: 3, text: "تنطبق بدرجة متوسطة" },
  ...
  },
  {
    ...
    axis: "تقدير الذات الرفاقي",
    question:
      "عندما يكون هناك مشكلة، فلست الشخص الذي يلجأ إليه الزملاء للمساعدة.",
    options: [
      { value: 5, text: "تنطبق تماما" },
      { value: 4, text: "تنطبق غالبا" },
      { value: 3, text: "تنطبق بدرجة متوسطة" },
