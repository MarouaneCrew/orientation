...
const anxietyQuestions = [
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_FUTUR",
    question:
      "أتوقع أن أجد صعوبات ترهقني مستقبلا للحصول على دخل يسد حاجاتي المعاشية.",
    options: [
      {
        value: 1,
        text: "تعبر عني تماما",
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_FUTUR",
    question:
      "أرى أن الهجرة إلى الخارج ستكون الحل الأخير لما أعانيه من مشكلات.",
    options: [
      {
        value: 1,
        text: "تعبر عني تماما",
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_FUTUR",
    question:
      "أخشى استمرار تدهور العلاقات الاجتماعية والإنسانية بين الأفراد في المستقبل.",
    options: [
      {
        value: 1,
        text: "تعبر عني تماما",
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_FUTUR",
    question:
      "عند مراجعتي الطبيب يؤكد أن ما أعانيه من الأم راجع إلى أسباب نفسية.",
    options: [
      {
        value: 1,
        text: "تعبر عني تماما",
  ...
  },
  {
    ...
    diagnostique: "ANXIETE_FUTUR",
    question:
      "أشعر بالاطمئنان على أفراد أسرتي على الرغم من انتشار الظواهر السلوكية غير السليمة.",
    options: [
      {
        value: 1,
        text: "تعبر عني تماما",
      ...
      <div className="container py-10">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl font-bold mb-6">
            Test d'Anxiété face aux future
          </h1>
