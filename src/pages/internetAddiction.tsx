...
const anxietyQuestions = [
  ...
  },
  {
    ...
    diagnostique: "DEPENDANCE_INTERNET",
    question:
      "هل يتضايق الآخرون المحيطون بك من الوقت الطويل الذي تقضيه أمام الانترنت؟",
    options: [
      { value: 1, text: "في كل الأوقات" },
      { value: 2, text: "في معظم الوقت" },
      { value: 3, text: "بصورة متوسطة" },
  ...
  },
  {
    ...
    diagnostique: "DEPENDANCE_INTERNET",
    question:
      "هل تأثرت نتائجك أو واجباتك الحياتية بسبب الوقت الذي تستغرقه على الانترنت؟",
    options: [
      { value: 1, text: "في كل الأوقات" },
      { value: 2, text: "في معظم الوقت" },
      { value: 3, text: "بصورة متوسطة" },
  ...
  },
  {
    ...
    diagnostique: "DEPENDANCE_INTERNET",
    question:
      "هل تشعر أنك فشلت في تقليص المدة الزمنية التي تقضيها أمام الانترنت على الرغم من محاولتك ذلك؟",
    options: [
      { value: 1, text: "في كل الأوقات" },
      { value: 2, text: "في معظم الوقت" },
      { value: 3, text: "بصورة متوسطة" },
  ...
  },
  {
    ...
    diagnostique: "DEPENDANCE_INTERNET",
    question:
      "هل تشعر أن المدة الزمنية التي تقضيها أمام شبكة الانترنت تسبب لك مشاكل مع أسرتك؟",
    options: [
      { value: 1, text: "في كل الأوقات" },
      { value: 2, text: "في معظم الوقت" },
      { value: 3, text: "بصورة متوسطة" },
  ...
  },
  {
    ...
    diagnostique: "DEPENDANCE_INTERNET",
    question:
      "هل ترى أن الجلوس أمام شبكة الانترنت أفضل من الخروج للتنزه مع الأصدقاء؟",
    options: [
      { value: 1, text: "في كل الأوقات" },
      { value: 2, text: "في معظم الوقت" },
      { value: 3, text: "بصورة متوسطة" },
  ...
  },
  {
    ...
    diagnostique: "DEPENDANCE_INTERNET",
    question:
      "هل تشعر أن الجلوس أمام شبكة الانترنت أفضل من مساعدة أسرتك في قضاء احتياجاتها؟",
    options: [
      { value: 1, text: "في كل الأوقات" },
      { value: 2, text: "في معظم الوقت" },
      { value: 3, text: "بصورة متوسطة" },
  ...
  },
  {
    ...
    diagnostique: "DEPENDANCE_INTERNET",
    question:
      "هل تشعر بالمتعة عند تصفحك لمواقع شبكة الانترنت على الرغم من التكلفة المادية والإرهاق الذي سببه ذلك لك؟",
    options: [
      { value: 1, text: "في كل الأوقات" },
      { value: 2, text: "في معظم الوقت" },
      { value: 3, text: "بصورة متوسطة" },
