...
const oceanQuestions: OceanQuestion[] = [
  ...
  },
  {
    ...
    axis: "الانفتاح",
    question:
      "أعتقد أن استمتاع الطلبة والتلاميذ إلى جدالات أو مناقشات (سیاسية أو فكرية أو دينية) بمكن أن بشوش تفكيرهم ویضللهم.",
    options: [
      {
        value: 5,
        text: "تنطبق علي بدرجة قليلة جدا",
  ...
  },
  {
    ...
    axis: "الانفتاح",
    question:
      "أعتقد بأنه یجب علینا الرجوع إلى الأعراف والتقاليد للحسم في المشكلات الأخلاقية.",
    options: [
      {
        value: 5,
        text: "تنطبق علي بدرجة قليلة جدا",
  ...
  },
  {
    ...
    axis: "الانفتاح",
    question:
      "أستمتع بالتفكير والاطلاع على النظریات والأفكار المجردة (غيرالملموسة)",
    options: [
      {
        value: 1,
        text: "تنطبق علي بدرجة قليلة جدا",
...
const OceanTest: React.FC = () => {
  ...
  const progressPercentage =
    ((currentQuestionIndex + 1) / oceanQuestions.length) * 100;
      ...
      <div className="container py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>
                السؤال {currentQuestionIndex + 1}/{oceanQuestions.length}
              </CardTitle>
              <CardDescription>
                ...
                >
                  <div className="space-y-3">
                    {currentQuestion.options.map((option) => (
                      <div
                        key={option.value}
                        className="flex items-center space-x-2 border p-3 rounded-md hover:bg-gray-50 text-right"
                      >
                        <RadioGroupItem
                        ...
                        />
                        <Label
                          htmlFor={`${currentQuestion.name}-${option.value}`}
