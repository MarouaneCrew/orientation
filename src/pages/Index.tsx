          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-lg md:text-xl opacity-90">
                OrientPro vous accompagne dans votre orientation avec des tests
                psychométriques personnalisés et des recommandations adaptées à
                votre profil unique.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link to="/register">
                  <Button
                    size="lg"
                    variant="outline"
                    className="bg-white text-orientpro-blue hover:bg-gray-100"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Notre approche scientifique et personnalisée vous aide à découvrir
              des opportunités professionnelles et académiques parfaitement
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="orientpro-card">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Des diagnostics scientifiquement validés comme RAISEC et Big 5
                  pour révéler vos traits dominants.
                </p>
                <Link
                  to="/diagnostics"
                  className="inline-flex items-center text-orientpro-blue hover:text-orientpro-blue/80"
                >
            ...
            <Card className="orientpro-card">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Des recommandations de carrières adaptées à votre profil
                  psychologique et vos centres d'intérêt.
                </p>
                <Link
                  to="/careers"
                  className="inline-flex items-center text-orientpro-blue hover:text-orientpro-blue/80"
            ...
            <Card className="orientpro-card">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Des itinéraires éducatifs personnalisés pour vous guider vers
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Un processus simple et efficace pour vous aider à trouver votre
              voie
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Inscrivez-vous gratuitement pour accéder à tous nos outils
                d'orientation.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Complétez les diagnostics pour révéler vos traits de
                personnalité.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Consultez les recommandations personnalisées de métiers et
                formations.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Des articles et guides pour vous accompagner dans votre
              orientation
            </p>
          </div>
            ...
            <Card className="orientpro-card">
              <CardContent className="p-0">
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-medium mb-2">
                    Comment choisir sa voie après le bac
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Les étapes clés pour prendre une décision éclairée sur votre
                    avenir académique.
                  </p>
                  <Link
                    to="/blog/1"
            ...
            <Card className="orientpro-card">
              <CardContent className="p-0">
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-medium mb-2">
                    Les métiers d'avenir en 2025
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Découvrez les secteurs en pleine croissance et les
            ...
            <Card className="orientpro-card">
              <CardContent className="p-0">
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-medium mb-2">
                    Préparer efficacement les concours d'entrée
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Stratégies et conseils pour réussir vos concours d'admission
                    aux grandes écoles.
                  </p>
                  <Link
                    to="/blog/3"
      ...
      <section className="py-16 bg-orientpro-blue text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg opacity-90 mb-8">
            Rejoignez les milliers d'étudiants qui ont trouvé leur voie grâce à
            OrientPro
          </p>
          <Link to="/register">
            <Button
